...
При выполнении заданий проекта следует вначале проработать все задания и затем выполнять комплексно. Результаты заданий в виде бизнес-требований и функционально-ролевой модели следует разместить в едином документе `BRD` (`Business Requirements Document`).
...
5. Разместить отчет в файле ex00\_<префикс продукта>\_rolegame.docx.
...
3. Подготовить протокол мозгового штурма. Отразить:
    ...
    2. По каждому блоку указать:
        ...
        2. Цели, проблемы;
        3. Предложения, идеи.
4. Разместить протокол в файле ex01\_<префикс продукта>\_brainstorming.docx.

**Рекомендации для подготовки к мозговому штурму:**

Перед мозговым штурмом следует:

1. Прочитать или посмотреть материалы: условия задачи, отчеты по интервью, результаты ex00 и ex02 в PIM_03, важные документы или интернет-ресурсы, относящиеся к задаче.
...
5. Разместить отчет в файле ex02\_<префикс продукта>\_seminar.docx.
...
6. Разместить документ в файле ex03\_<префикс продукта>\_vision.docx.


**Рекомендации по выполнению задания:**

- Задействуй ИИ-помощников, если не нашлось участников для проведения ролевой игры, мозгового штурма, семинара.
